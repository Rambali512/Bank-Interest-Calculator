function output(){
    ...
    let display6 = Number(document.getElementById("item6").value);
    let sum;
    let total;

    let arr = [display1,display2,display3,display4,display5,display6];
    let arr2 = [];
    ...
    document.getElementById("output6").innerText = arr2[5];
}